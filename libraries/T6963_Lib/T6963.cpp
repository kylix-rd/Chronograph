...
//-------------------------------------------------------------------------------------------------
void T6963::glcd_print2(unsigned char x,unsigned char y, const char *in, const struct FONT_DEF *strcut1, unsigned char invers)
{
...
void T6963::glcd_print2_P(unsigned char x,unsigned char y, PGM_P in, const struct FONT_DEF *strcut1, unsigned char invers)
{
	char c;
	char buffer[80];
	int i = 0;
	while ((c = pgm_read_byte(in++)) && i < sizeof(buffer))
		buffer[i++] = c;
	buffer[i] = 0;
	glcd_print2(x, y, buffer, strcut1, invers);
}
...
//-------------------------------------------------------------------------------------------------
void T6963::glcd_print1(unsigned char x,unsigned char y, const char *in, const struct FONT_DEF *strcut1, unsigned char invers)
{
	unsigned int offset;
...
void T6963::glcd_print1_P(unsigned char x,unsigned char y, PGM_P in, const struct FONT_DEF *strcut1, unsigned char invers)
{
	char c;
	char buffer[80];
	int i = 0;
	while ((c = pgm_read_byte(in++)) && i < sizeof(buffer))
		buffer[i++] = c;
	buffer[i] = 0;
	glcd_print1(x, y, buffer, strcut1, invers);
}
