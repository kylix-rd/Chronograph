...
#define GLCD_DATA_PIN		PINC		//Arduino Mega Pins 37-30
#define GLCD_DATA_DDR		DDRC

// control port Arduino Mega
#define GLCD_CTRL_PORT		PORTA
#define GLCD_CTRL_PIN		PINA		//Arduino Mega Pins 22-25
...
public:
  ...
  void glcd_print2_P(unsigned char, unsigned char, PGM_P, const FONT_DEF*, unsigned char);
  void glcd_print1_P(unsigned char, unsigned char, PGM_P, const FONT_DEF*, unsigned char);
  void glcd_print2(unsigned char, unsigned char, const char *, const FONT_DEF*, unsigned char);
  void glcd_print1(unsigned char, unsigned char, const char *, const FONT_DEF*, unsigned char);
  ...
  uint16_t getWidth() { return GLCD_PIXELS_PER_LINE; };
  uint16_t getHeight() { return GLCD_NUMBER_OF_LINES; };
